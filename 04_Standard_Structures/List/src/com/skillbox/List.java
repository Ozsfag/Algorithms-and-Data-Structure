...
public class List {
  ...
  // This function should return copy of the list where every second element is removed. Initial
  // list should not be changed.
  // E.g. if we run copyEverySecond on list [1, 2, 3, 4, 5, 6, 7, 100, 120, 162, 0, 1] new list with
  // values [1, 3, 5, 7, 120, 0] should be returned.
  ...
  // This function converts our list to an array. New array is created with values the same as in
  // list.
  public int[] toArray() {
