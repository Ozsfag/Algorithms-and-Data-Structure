...
import homework.HashFunctions.HashFunctions;
...
public class HashFunctionsTest {
  ...
  void hashString(String string, int expectedHash) {
    assertEquals(
        expectedHash, HashFunctions.hashString(string), "wrong hash for string=<" + string + ">");
  }
  ...
  void hashIntValue(Integer integer, Integer expectedHash) {
    assertEquals(
        expectedHash, HashFunctions.hashInt(integer), "wrong hash for int=<" + integer + ">");
  }
}
