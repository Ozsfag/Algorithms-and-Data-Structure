...
public class SortedCheck {
  ...
  public static boolean isSorted(int[] array) {
    ...
    for (int i = 1; i < array.length; i++) { // Идем по массиву начиная с индекса 1
      // В отсортированном массиве каждый следующий элемент должен быть больше либо равен
      // предыдущему
      if (array[i]
          < array[
              i - 1]) { // если вдруг текущий элемент МЕНЬШЕ предыдущего, то массив не отсортирован
        return false;
      }
    }
    return true;
    // если цикл закончился, значит условие с return false ни разу не сработало, и можно возвращать
    // true
  }
}
