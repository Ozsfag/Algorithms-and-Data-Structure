...
public class RemoveDuplicates {
  ...
  public static int removeDuplicates(int[] array) {
    ...
    // Здесь мы будем использовать необычный цикл для обхода массива, ведь согласно нашему плану мы
    // будем сами
    ...
    while (i < length) {
      ...
      // А вот если мы его все же нашли, то пора заняться коррупционерствованием и украсть
      // дублирующуюся
      // статью бюджета !
        ...
        // Нам потребуется еще один точно такой же цикл начиная от следующего элемента и заканчивая
        // концом массива
        for (int k = i + 1; k < length; k++) {
          array[k - 1] = array[k];
        }
        ...
        length--;
        // и еще не время двигаться дальше, потому что нам нужно снова рассмотреть новый i-ый
        // элемент, так что i мы пока не меняем
        continue;
      }
    }
    return length;
