...
public class Doka4Test {
  ...
  private static final Doka3.Player[] players =
      new Doka3.Player[] {
  ...
  static Doka3.Player[] expectedInsert =
      new Doka3.Player[] {
        new Doka3.Player(1100, "Crowbar Freeman"),
        new Doka3.Player(1200, "London Mollarik"),
        new Doka3.Player(1600, "Raziel of Kain"),
  ...
  void insertPlayer(
      Doka3.Player[] players, Doka3.Player newPlayer, int index, Doka3.Player[] expectedPlayers) {
