...
class BinarySearchTest {
  ...
  static Stream<Arguments> languages() {
    return Stream.of(
        Arguments.of(new String[] {"ADA", "ALGOL", "B", "BASIC", "C", "C++"}, "BASIC", true),
  ...
  static Stream<Arguments> iqList() {
    ...
    return Stream.of(
        ...
        Arguments.of(
            datingUsers, 80, 110, List.of("Максим", "Виктория", "Артём", "Дарья", "Мария")),
